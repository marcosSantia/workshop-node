...
router.get('/characters', (req, res)=>res.send('En teoria esto deberia devolver todos los caracteres pero aun no se quien me los va dar.'));
...
router.delete('/character/:id/delete', (req, res)=>res.send('En teoria tendria que enviar los datos para eliminar un character en funcion del ID proporcionado.'));
